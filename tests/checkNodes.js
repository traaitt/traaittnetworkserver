...
const data = require('../traaitt-nodes.json')
...
function checkTestNode (node) {
  ...
  return request({ url: 'https://raw.githubusercontent.com/turtlecoin/traaitt-nodes-json/master/traaitt-nodes.json', json: true })
    .then(data => {
